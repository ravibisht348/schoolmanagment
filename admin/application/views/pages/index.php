...
?>
                      <tr>
                        ...
                        <td class="text-center"><a href="<?= base_url()?>pages/add/<?=$row->{'ID'}?>" class="btn btn-primary btn-sm"><i class="far fa-edit"></i> Edit</a>
                            <a href="<?= base_url()?>pages/delete/<?=$row->{'ID'}?>" onclick="return confirm('Are you sure you want to delete this product?')"class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i> Delete</a>
                          </td>
                      </tr>
<?php
}
